  ...
  return (
    <main>
      ...
      <section id="submit" className="submit-section" aria-labelledby="submit-heading">
        ...
        <div className="submit-copy"><p>Submissions are checked for ownership context, reachable content, DNSSEC, TLSA, and clear visitor value. Nothing is published automatically.</p><button onClick={copySubmissionTemplate}>{copied ? <Check size={17} /> : <ArrowRight size={17} />}{copied ? 'Template copied' : 'Copy submission template'}</button><a href="https://skyinclude.com/contact" target="_blank" rel="noreferrer">Send it to the directory team <ExternalLink size={14} /></a></div>
      </section>
